...
対戦の場では、この形を**バレット**と呼びます。相手のポケモンに応じて攻撃役を選び、そのつど有利を作る戦い方です。
...
第4が、引ける確率との戦いです。1枚ずつ入れたカードは、必要な場面で引けるとは限りません。**探す手段をどれだけ厚くできるかが、成立の条件**です。
...
どちらを選ぶかは、参加する大会の規模でも変わります。==当たる相手が読める場では絞る構築、幅広い相手に当たる場ではバレット==という分け方も一つの考えです。
...
拡張パック「ムニキスゼロ」に収録された特殊エネルギーです。このパックは**2026年1月23日に発売**されました。
...
**トラッシュから基本エネルギーを1枚選び、ベンチのポケモンにつけられる**グッズです。
...
たとえばミュウツーexのようなテラスタルのポケモンなら、**ベンチにいるかぎりワザのダメージを受けない性質**を活かせます。準備の時間を安全に確保できる点が利点です。
...
中盤は、相手のバトル場を見て攻撃役を決めます。**弱点を突けるポケモンがいれば、それを前に出すのが基本**です。
...
弱点の1つ目は、**引ける確率**です。1枚ずつ入れたカードは、必要な場面で手札に来るとは限りません。探す手段が細いと、対応力そのものが機能しなくなります。
...
**弱点を突いたワザのダメージは2倍**として計算されます。100のワザなら200です。この倍率があるからこそ、控えめな打点のポケモンでも役割を持てます。
...
関連記事：[古代デッキとは？サポートカードの役割と組み方を解説](/column/ancient-deck/)
